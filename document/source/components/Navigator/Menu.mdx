...
[Material Design Guidelines: menus][1]

## Example usage

### Basic

Note, `mwc-menu` internally uses [`mwc-list`][2],
...
<Example>
    <div style={{ position: 'relative' }}>
        <mwc-button
            raised
            label="Open Menu"
            onClick={({ target }) => (target as HTMLElement).nextElementSibling.show()}
        />
        <mwc-menu>
...
<Example>
    <mwc-button
        ...
        onClick={({ target }) => (target as HTMLElement).nextElementSibling.show()}
    />
    <mwc-menu fixed ref={menu => menu.anchor = menu.previousElementSibling}>
        <mwc-list-item>Item 0</mwc-list-item>
        <mwc-list-item>Item 1</mwc-list-item>
        <mwc-list-item>Item 2</mwc-list-item>
        <mwc-list-item>Item 3</mwc-list-item>
...
render(
    <>
        <mwc-button
            ...
            onClick={({ target }) => (target as HTMLElement).nextElementSibling.show()}
        />
        <mwc-menu fixed ref={(menu: Menu) => menu.anchor = menu.previousElementSibling}>
            <mwc-list-item>Item 0</mwc-list-item>
            <mwc-list-item>Item 1</mwc-list-item>
            <mwc-list-item>Item 2</mwc-list-item>
            <mwc-list-item>Item 3</mwc-list-item>
...
`[mwc-list-item]`s in the same group and make selection function similarly to a radio group.
...
`mwc-menu` internally uses [`mwc-list`][2],
...
| `wrapFocus`           | `boolean`                           | `false`       | Proxies to [`mwc-list`'s][3] `wrapFocus` property.                                                                                                                                                                                                          |
| `innerRole`           | `"menu"                             | "listbox"`    | `"menu"`                                                                                                                                                                                                                                                    |
| `multi`               | `boolean`                           | `false`       | Proxies to [`mwc-list`'s][3] `multi` property.                                                                                                                                                                                                              |
| `activatable`         | `boolean`                           | `false`       | Proxies to [`mwc-list`'s][3] `activatable` property.                                                                                                                                                                                                        |
| `items`               | `ListItemBase[]` (readonly)         | `[]`          | Proxies to [`mwc-list`'s][3] `items` property.                                                                                                                                                                                                              |
| `index`               | `MWCListIndex` (readonly)\*\*\*\*   | `-1`          | Proxies to [`mwc-list`'s][3] `index` property.                                                                                                                                                                                                              |
| `selected`            | `SelectedType` (readonly)\*\*\*\*\* | `null`        | Proxies to [`mwc-list`'s][3] `selected` property.                                                                                                                                                                                                           |
...
\* See [`mwc-list`'s Events section][4] for more details.
...
`mwc-menu` internally uses [`mwc-list`][5], see the [styling documentation][5] for further details.
...
[1]: https://material.io/design/components/menus.html
[2]: components/content/list
[3]: https://github.com/material-components/material-components-web-components/tree/master/packages/list#mwc-list-1
[4]: https://github.com/material-components/material-components-web-components/tree/master/packages/list#mwc-list-2
[5]: https://github.com/material-components/material-components-web-components/tree/master/packages/list#css-custom-properties
[6]: https://github.com/material-components/material-components-web-components/blob/master/docs/theming.md
[7]: https://material.io/develop/web/components/menus/
