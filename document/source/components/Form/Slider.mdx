...
[Material Design Guidelines: sliders][1]
...
<Example>
    <mwc-slider value={25} min={10} max={50} />
</Example>
...
<Example>
    <mwc-slider step={5} pin markers max={50} value={10} />
</Example>
...
<Example id="styled">
    ...
    <mwc-slider pin markers max={50} value={10} step={5} />
</Example>
...
| ---------- | ------------ | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `input`    | `mwc-slider` | `Slider` | Fired when the value changes due to user input. Similar to the [`input` event of the native `<input type="range">` element][2], the `input` event will not fire when `value` is modified via JavaScript.                                       |
| `change`   | `mwc-slider` | `Slider` | Fired when the value changes and the user has finished interacting with the slider. Similar to the [`change` event of the native `<input type="range">` element][3], the `change` event will not fire when `value` is modified via JavaScript. |

### CSS Custom Properties

| Name                                     | Default              | Description                                                                                                                                                                     |
| ---------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--mdc-slider-bg-color-behind-component` | <Color>white</Color> | Sets the color of the circle around the knob on the disabled slider to make it seem cut-out. May be necessary when placing a disabled slider on a different-colored background. |
...
[1]: https://material.io/design/components/sliders.html
...
[5]: https://material.io/components/sliders
