...
[Material Design Guidelines: lists][1]
...
<Example id="leading-graphic">
    <style>
        {`#leading-graphic mwc-icon {
...
<Example>
    <mwc-list>
        ...
        <li divider inset padded role="separator" />
        <mwc-list-item graphic="avatar">
            <span>avatar item</span>
            <mwc-icon slot="graphic">folder</mwc-icon>
        </mwc-list-item>
...
<Example>
    <mwc-list multi>
        ...
        <li divider role="separator" padded />
        <mwc-check-list-item left selected>
            Item 2 (left)
        </mwc-check-list-item>
...
Setting `group` on the `radio-list-item` will group those `mwc-radio`s together across the same Document.

<Example>
    <mwc-list>
        <mwc-radio-list-item group="a" selected>
            Item 0
        </mwc-radio-list-item>
        <mwc-radio-list-item group="a">Item 1</mwc-radio-list-item>
        <li divider padded role="separator" />
        <mwc-radio-list-item left group="a">
            Item 2 (left)
        </mwc-radio-list-item>
        <mwc-radio-list-item left group="a">
            Item 3 (left)
...
<Example>
    <mwc-list multi>
        ...
        <mwc-radio-list-item group="b" selected>
            Item 1
        </mwc-radio-list-item>
        <li divider role="separator" />
        <mwc-radio-list-item group="c" selected>
            Item 2
        </mwc-radio-list-item>
...
<Example>
    ...
    <mwc-list>
        <mwc-list-item twoline graphic="avatar" noninteractive>
            ...
            <mwc-icon slot="graphic" className="inverted">
                tag_faces
            </mwc-icon>
        </mwc-list-item>
        <li divider role="separator" />
...
custom properties detailed in [`mwc-ripple`'s documentation][2]. In this case,
...
of `mwc-list-item`, so all properties in `mwc-list-item` will be available on `mwc-radio-list-item`.
...
`mwc-list-item` internally uses [`mwc-ripple`][2] and thus exposes all of the custom properties in `mwc-ripple`'s documentation
with the exception of `--mdc-ripple-color` being overriden as `--mdc-theme-primary` when `mwc-list-item` is `activated`.
